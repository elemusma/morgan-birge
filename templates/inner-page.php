...
// } else {
    ...
    // echo '</div>';
// }
echo '<div class="position-relative pt-5 pr-4 pl-4 h-100 d-flex align-items-end col-services" style="background:rgba(0,0,0,.45);padding-top:100px;">';
...
echo '<div class="pl-4 pr-4 small text-left">';
